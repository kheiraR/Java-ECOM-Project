...
<app:layout pageTitle="ECOM - Categories" columnNumber="two">

    <div id="sidebar">
        <div id="taxonomies" class="sidebar-item">
            <ul class="navigation-list">
                <li><a href="categories/" class="root">Shop by Category</a></li>
		<c:forEach items="${categories}" var="cat">
		    <li><a href="category/${cat.idCategory}">${cat.name}</a></li>
		</c:forEach>
            </ul>
            <ul class="navigation-list">
